...
@Service
public class DeepgramTokenServiceImpl implements DeepgramTokenService {
    private static final Logger logger = LoggerFactory.getLogger(DeepgramTokenServiceImpl.class);

    private final String masterApiKey;
    private final RestTemplate restTemplate = new RestTemplate();
    private String cachedProjectId = null;

    public DeepgramTokenServiceImpl(@Value("${app.deepgram.api-key}") String masterApiKey) {
